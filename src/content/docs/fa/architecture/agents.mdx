...
> برای دستورالعمل‌های راه‌اندازی و استفاده به [Music Agent README](https://github.com/bedrud-ir/bedrud/tree/main/agents/music_agent) ببینید.
...
> برای دستورالعمل‌های راه‌اندازی و استفاده به [Radio Agent README](https://github.com/bedrud-ir/bedrud/tree/main/agents/radio_agent) ببینید.
...
> برای دستورالعمل‌های راه‌اندازی و استفاده به [Video Stream Agent README](https://github.com/bedrud-ir/bedrud/tree/main/agents/video_stream_agent) ببینید.
