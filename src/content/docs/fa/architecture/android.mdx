...
│                          │
│  ┌────────────────────┐  │
│  │   InstanceStore    │  │  لیست را در SharedPreferences پایدار می‌کند
│  └────────────────────┘  │
│                          │
│  ┌────────────────────┐  │
...
```
بدون نمونه ──► AddInstanceScreen
نمونه دارد، وارد نشده ──► LoginScreen
نمونه دارد، وارد شده ──► DashboardScreen
```
