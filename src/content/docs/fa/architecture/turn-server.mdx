...
|------|----------|---------|-------------|-------|
| ۴۴۳ | TCP | HTTPS + TURN/TLS | بله | API + رابط کاربری وب. همچنین TURN/TLS اگر `tls_port: 443`. |
...
- [مرجع پیکربندی](/docs/getting-started/configuration) - تمام گزینه‌های پیکربندی
- [TLS داخلی](/docs/guides/internal-tls) - TLS برای شبکه‌های ایزوله
- [راهنمای استقرار](/docs/guides/deployment) - مراحل استقرار تولید
