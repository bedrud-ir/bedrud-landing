...
برای عیب‌یابی عمیق TURN، به [راهنمای سرور TURN](/docs/architecture/turn-server) مراجعه کنید.

---

## همچنین ببینید

- [راهنمای سرور TURN](/docs/architecture/turn-server) - معماری، پیکربندی، TLS، عیب‌یابی TURN
...
- [TLS داخلی](/docs/guides/internal-tls) - TLS برای شبکه‌های ایزوله
