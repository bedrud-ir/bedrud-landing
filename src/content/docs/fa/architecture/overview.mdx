...
برای جزئیات به [معماری سرور](/fa/docs/architecture/server) مراجعه کنید.
...
برای جزئیات به [فرانت‌اند وب](/fa/docs/architecture/web) مراجعه کنید.
...
برای جزئیات به [اپلیکیشن Android](/fa/docs/architecture/android) مراجعه کنید.
...
برای جزئیات به [اپلیکیشن iOS](/fa/docs/architecture/ios) مراجعه کنید.
...
برای جزئیات به [اپلیکیشن دسکتاپ](/fa/docs/architecture/desktop) مراجعه کنید.
...
برای جزئیات به [عوامل ربات](/fa/docs/architecture/agents) مراجعه کنید.
...
برای پشته اتصال کامل به [اتصال WebRTC](/fa/docs/architecture/webrtc-connectivity) مراجعه کنید.
...
برای دستورالعمل‌های تنظیم به [راهنمای استقرار](/fa/docs/guides/deployment) مراجعه کنید.
