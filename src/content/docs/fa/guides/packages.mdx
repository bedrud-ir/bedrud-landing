...
See the [Installation Guide](/docs/getting-started/installation) for all configuration options.
...
See the [Docker Guide](/docs/guides/docker) for full details including volume mounts and reverse proxy setup.
