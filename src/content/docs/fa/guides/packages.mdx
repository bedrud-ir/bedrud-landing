...
به [راهنمای نصب](/docs/getting-started/installation) برای تمام گزینه‌های پیکربندی مراجعه کنید.
...
به [راهنمای Docker](/docs/guides/docker) برای جزئیات کامل شامل سوار کردن حجم و تنظیم پروکسی معکوس مراجعه کنید.
