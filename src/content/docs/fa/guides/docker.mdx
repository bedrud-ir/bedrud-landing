...
- [مرجع پیکربندی](/docs/getting-started/configuration) - گزینه‌های کامل پیکربندی و متغیرهای محیطی
- [راهنمای استقرار](/docs/guides/deployment) - استقرار در تولید با Docker
