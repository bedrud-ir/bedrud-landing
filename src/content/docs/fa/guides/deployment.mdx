...
| [حالت لوازم](/fa/docs/guides/appliance) | تنظیمات همه‌کاره تک‌باینری |
...
به [راهنمای نصب بسته](/fa/docs/guides/packages) برای دستورالعمل‌های کامل، از جمله افزودن کلید GPG apt و مخزن مراجعه کنید.
...
به [راهنمای نصب](/fa/docs/getting-started/installation) برای تمام سناریوهای نصب مراجعه کنید.
...
به [راهنمای Docker](/fa/docs/guides/docker) برای جزئیات کامل شامل حجم‌ها، پیکربندی و Docker Compose مراجعه کنید.
...
به [اتصال WebRTC](/fa/docs/architecture/webrtc-connectivity) برای پشته اتصال کامل مراجعه کنید.
