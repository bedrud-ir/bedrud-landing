...
> به [معماری سرور](/docs/architecture/server) برای چیدمان کامل دایرکتوری و طراحی لایه‌ای مراجعه کنید.
...
> به [معماری فرانت‌اند وب](/docs/architecture/web) برای ساختار کامل و الگوهای فرانت‌اند مراجعه کنید.
...
> به [معماری برنامه Android](/docs/architecture/android) برای معماری دقیق برنامه موبایل مراجعه کنید.
...
> به [معماری برنامه iOS](/docs/architecture/ios) برای معماری دقیق برنامه موبایل مراجعه کنید.
...
> به [معماری برنامه دسکتاپ](/docs/architecture/desktop) برای معماری دقیق برنامه دسکتاپ مراجعه کنید.
...
- [مرجع Makefile](/docs/guides/makefile) - تمام دستورات ساخت و توسعه
- [نمای کلی معماری](/docs/architecture/overview) - نحوه تناسب اجزا
