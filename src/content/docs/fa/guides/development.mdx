...
> See [Server Architecture](/docs/architecture/server) for the full directory layout and layered design.
...
> See [Web Frontend Architecture](/docs/architecture/web) for the complete frontend structure and patterns.
...
> See [Android App Architecture](/docs/architecture/android) for detailed mobile app architecture.
...
> See [iOS App Architecture](/docs/architecture/ios) for detailed mobile app architecture.
...
> See [Desktop App Architecture](/docs/architecture/desktop) for detailed desktop app architecture.
...
- [Makefile Reference](/docs/guides/makefile) — all build and dev commands
- [Architecture Overview](/docs/architecture/overview) — how components fit together
