...
۴. **افزودن middleware** اگر نقطه پایانی به بررسی‌های auth یا admin نیاز دارد
...
> به [معماری سرور](/fa/docs/architecture/server) برای چیدمان کامل دایرکتوری و طراحی لایه‌ای ببینید.
...
> به [معماری فرانت‌اند وب](/fa/docs/architecture/web) برای ساختار کامل و الگوهای فرانت‌اند ببینید.
...
> به [معماری برنامه Android](/fa/docs/architecture/android) برای معماری دقیق برنامه موبایل ببینید.
...
> به [معماری برنامه iOS](/fa/docs/architecture/ios) برای معماری دقیق برنامه موبایل ببینید.
...
> به [معماری برنامه دسکتاپ](/fa/docs/architecture/desktop) برای معماری دقیق برنامه دسکتاپ ببینید.
