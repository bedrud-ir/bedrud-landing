...
**همچنین ببینید:** [شروع سریع](/docs/getting-started/quickstart) | [نصب](/docs/getting-started/installation) | [راهنمای استقرار](/docs/guides/deployment) | [راهنمای Docker](/docs/guides/docker)
...
برای معماری و عیب‌یابی به [اتصال WebRTC](/docs/architecture/webrtc-connectivity) مراجعه کنید.
...
برای معماری، جزئیات تنظیمات، محاسبات پهنای باند و عیب‌یابی به [راهنمای سرور TURN](/docs/architecture/turn-server) مراجعه کنید.
...
برای استقرار Docker، به [راهنمای Docker](/docs/guides/docker) مراجعه کنید.
...
برای تنظیم کامل تولید، به [راهنمای استقرار](/docs/guides/deployment) مراجعه کنید.
