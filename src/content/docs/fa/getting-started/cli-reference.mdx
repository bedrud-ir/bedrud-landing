...
**اسناد مرتبط:** [راهنمای نصب](/docs/getting-started/installation) • [راهنمای استقرار](/docs/guides/deployment) • [منطق استقرار بک‌اند](/docs/backend/deployment)
...
**اسناد مرتبط:** [راهنمای نصب - حذف](/docs/getting-started/installation#uninstallation)
...
- [راهنمای نصب](/docs/getting-started/installation) - راهنمای دقیق `bedrud install`، توپولوژی‌های TLS، مراحل پس از نصب
- [مرجع پیکربندی](/docs/getting-started/configuration) - ساختار فایل تنظیمات سرور و LiveKit
- [منطق استقرار بک‌اند](/docs/backend/deployment) - نحوه کار `install` و `uninstall` به صورت داخلی
- [راهنمای استقرار](/docs/guides/deployment) - گزینه‌های کامل استقرار شامل سرویس‌های systemd
