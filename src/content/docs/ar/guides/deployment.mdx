...
| [وضع الجهاز الجاهز](/docs/guides/appliance) | إعداد شامل بملف ثنائي واحد |
...
راجع [دليل تثبيت الحزم](/docs/guides/packages) للتعليمات الكاملة، بما في ذلك إضافة مفتاح GPG الخاص بـ apt والمستودع.
...
راجع [دليل التثبيت](/docs/getting-started/installation) لجميع سيناريوهات التثبيت.
...
راجع [دليل Docker](/docs/guides/docker) للتفاصيل الكاملة بما في ذلك الأقراص والإعدادات وDocker Compose.
...
راجع [اتصال WebRTC](/docs/architecture/webrtc-connectivity) للاطلاع على حزمة الاتصال الكاملة.
