...
> راجع [بنية الخادم](/ar/docs/architecture/server) للاطلاع على هيكل الدليل الكامل والتصميم الطبقي.
...
> راجع [بنية واجهة الويب](/ar/docs/architecture/web) للاطلاع على الهيكل الكامل والأنماط.
...
> راجع [بنية تطبيق Android](/ar/docs/architecture/android) للاطلاع على بنية التطبيق المحمول بالتفصيل.
...
> راجع [بنية تطبيق iOS](/ar/docs/architecture/ios) للاطلاع على بنية التطبيق المحمول بالتفصيل.
...
> راجع [بنية تطبيق سطح المكتب](/ar/docs/architecture/desktop) للاطلاع على بنية تطبيق سطح المكتب بالتفصيل.
...
- [مرجع Makefile](/ar/docs/guides/makefile) - جميع أوامر البناء والتطوير
- [نظرة عامة على البنية](/ar/docs/architecture/overview) - كيف تتلاءم المكونات معًا
