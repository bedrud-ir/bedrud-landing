...
يغطي هذا الدليل تثبيت **خادم بدرود** (واجهة برمجة التطبيقات، واجهة الويب، خادم وسائط WebRTC) على خادم لينكس. لتطبيقات العميل على سطح المكتب والهاتف المحمول، راجع [تثبيت العميل](/docs/getting-started/clients).
...
> **لا تملك نطاقاً؟** يعمل بدرود مع عنوان IP باستخدام TLS موقّع ذاتياً. ستُظهر المتصفحات تحذير شهادة لكن الفيديو والصوت يعملان. للحصول على شهادات موثوقة على الشبكات الداخلية، راجع [دليل TLS الداخلي](/docs/guides/internal-tls).
...
<Callout type="tip">
    لتثبيت عميل سطح المكتب (Linux، macOS، Windows) راجع [تثبيت العميل](/docs/getting-started/clients).
</Callout>
...
وثائق Docker الكاملة بما في ذلك الأحجام والبروكسي العكسي وإعداد TLS: [دليل Docker](/docs/guides/docker).
...
| **تحذيرات شهادة موقّعة ذاتياً** | متوقع. راجع [دليل TLS الداخلي](/docs/guides/internal-tls) لإعداد CA خاص |
