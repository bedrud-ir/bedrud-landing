...
لاستكشاف مشاكل `TURN` بعمق، راجع [دليل خادم TURN](/docs/architecture/turn-server).

---

## انظر أيضًا

- [دليل خادم TURN](/docs/architecture/turn-server) - بنية `TURN` وتهيئته وTLS وتصحيح الأخطاء
- [تكامل LiveKit](/docs/backend/livekit) - كيف يُدمَج LiveKit في بدرود
- [نظرة عامة على البنية](/docs/architecture/overview) - بنية النظام الكاملة
