...
See [Server Architecture](/en/docs/architecture/server) for details.
...
See [Web Frontend](/en/docs/architecture/web) for details.
...
See [Android App](/en/docs/architecture/android) for details.
...
See [iOS App](/en/docs/architecture/ios) for details.
...
See [Desktop App](/en/docs/architecture/desktop) for details.
...
See [Bot Agents](/en/docs/architecture/agents) for details.
...
See [Deployment Guide](/en/docs/guides/deployment) for setup instructions.
...
- [TURN Server Guide](/en/docs/architecture/turn-server) - TURN relay architecture and configuration
