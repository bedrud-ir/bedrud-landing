...
- [Architecture Overview](/en/docs/architecture/overview) - data model and meeting connection flow
- [API Handlers](/en/docs/backend/api-handlers) - how room endpoints are implemented
