...
- [Authentication Flow](/docs/backend/authentication) - how JWT, OAuth, and passkeys work internally
- [Passkeys API](/docs/api/passkeys) - FIDO2/WebAuthn endpoint reference
