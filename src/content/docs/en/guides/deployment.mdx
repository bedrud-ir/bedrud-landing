...
| [Appliance Mode](/en/docs/guides/appliance) | Single-binary all-in-one setup |
...
See the [Package Installation guide](/en/docs/guides/packages) for full instructions, including adding the apt GPG key and repository.
...
See the [Installation Guide](/en/docs/getting-started/installation) for all installation scenarios.
...
See the [Docker Guide](/en/docs/guides/docker) for full details including volumes, configuration, and Docker Compose.
