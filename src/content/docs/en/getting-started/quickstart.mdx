...
**This guide:** Download → Install → Verify → Join. For alternatives see [Installation](/en/docs/getting-started/installation). For config see [Configuration](/en/docs/getting-started/configuration).
...
- [Installation Guide](/en/docs/getting-started/installation) - package managers, advanced flags, all methods
