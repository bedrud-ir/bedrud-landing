...
- [**Code Structure**](/en/docs/backend/structure): Where is everything located?
- [**Database & Models**](/en/docs/backend/database): How is data stored?
- [**Authentication**](/en/docs/backend/authentication): How do users log in?
- [**API Handlers**](/en/docs/backend/api-handlers): How are requests processed?
- [**LiveKit Integration**](/en/docs/backend/livekit): How does the video server work?
- [**WebRTC Connectivity**](/en/docs/architecture/webrtc-connectivity): How do clients establish media connections? (STUN/ICE/TURN/SFU)
- [**TURN Server**](/en/docs/architecture/turn-server): TURN relay architecture, configuration, and troubleshooting
- [**Installation & Deployment**](/en/docs/backend/deployment): How does the auto-installer work?
