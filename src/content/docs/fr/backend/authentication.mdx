...
- **Cérémonie d'Authentification :**
   ...
   2.  **Fin :** Le client signe le challenge avec sa clé privée. Le serveur récupère la Clé Publique de la base de données, vérifie la signature, et vérifie le **Compteur de Signe**.
