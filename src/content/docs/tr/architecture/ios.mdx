...
│  ├── instances: [Instance]│
│  ├── activeInstance       │
│  ├── authManager          │──► Örnek başına
│  ├── apiClient            │    bağımlılık
│  ├── roomManager          │    konteyneri
│  └── ...                  │
└──────────────────────────┘
```
...
```text
Örnek yok ──► AddInstanceView
Örnek var, giriş yapılmamış ──► LoginView
Örnek var, giriş yapılmış ──► DashboardView
```
