...
│                          │
│  ┌────────────────────┐  │
│  │   InstanceStore    │  │  Listeyi SharedPreferences'a kaydeder
│  └────────────────────┘  │
│                          │
│  ┌────────────────────┐  │
│  │  Aktif Örnek       │──┼──► InstanceDeps
...
```
Örnek yok ──► AddInstanceScreen
Örnek var, giriş yapılmamış ──► LoginScreen
Örnek var, giriş yapılmış ──► DashboardScreen
```
