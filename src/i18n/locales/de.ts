export default {
  ...
  hero: {
    ...
    headline: "Videokonferenzen, die Ihnen gehören",
    subtitle:
      "Eine einzelne Binärdatei mit Web-UI, REST-API und WebRTC-Medienserver. Selbst hosten oder von uns betreiben lassen.",
    getStarted: "Loslegen",
  ...
  features: {
    ...
    subtitle:
      "Bedrud wird als einzelne, eigenständige Binärdatei mit allem Integrierten geliefert.",
    singleBinary: {
      title: "Einzelne Binärdatei",
      description:
        "Eine Datei, keine Abhängigkeiten. Herunterladen, starten, fertig. Kein Docker, kein Kubernetes.",
    },
    webrtcVideo: {
      title: "WebRTC-Video",
      description:
        "Video und Audio mit niedriger Latenz, Peer-to-Peer, angetrieben durch einen integrierten WebRTC-Medienserver.",
    },
    multiPlatform: {
      title: "Multiplattform",
      description:
        "Native Clients für Web, Android und iOS — plus serverseitige Bots für Automatisierung.",
    },
    flexibleAuth: {
      title: "Flexible Authentifizierung",
      description:
        "Integrierte Authentifizierung mit Unterstützung für SSO, OAuth und benutzerdefinierte Identitätsanbieter.",
    },
    botAgents: {
      title: "Bot-Agenten",
      description:
        "Programmierbare Bots, die an Meetings teilnehmen, transkribieren, übersetzen und sich in Ihre Tools integrieren können.",
    },
    selfHosted: {
      title: "Ihre Infrastruktur oder unsere",
      description:
        "Selbst hosten für volle Kontrolle über Ihre Daten, oder Bedrud Cloud nutzen und uns den Betrieb überlassen. Ihre Wahl.",
    },
  },
  platforms: {
    title: "Eine Plattform, jedes Gerät",
    subtitle:
      "Native Erfahrungen auf allen Plattformen, gebaut mit modernen Technologien.",
    web: {
      title: "Web",
  ...
  openSource: {
    title: "Open Source, offene Zukunft",
    subtitle:
      "Bedrud ist vollständig Open Source unter der AGPLv3 Lizenz. Code einsehen, beitragen oder forken — es gehört Ihnen.",
    license: "AGPLv3",
